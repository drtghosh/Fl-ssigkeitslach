...
void geometry::write_particles_to_vtk(std::string path, const std::vector<Eigen::Vector3d>& particles)
{
	write_particles_to_vtk(path, particles, std::vector<double>(), std::vector<Eigen::Vector3d>());
}

void geometry::write_empty(std::string path)
{
	std::vector<Eigen::Vector3d> empty;
	write_particles_to_vtk(path, empty);
}

void geometry::write_tri_mesh_to_vtk(std::string path, const std::vector<Eigen::Vector3d>& vertices, const std::vector<std::array<int, 3>>& triangles, const std::vector<Eigen::Vector3d>& normals)
{
	// Open the file
...
void geometry::write_particles_to_vtk(std::string path, const std::vector<Eigen::Vector3d>& particles, const std::vector<double>& particle_scalar_data, const std::vector<Eigen::Vector3d>& particle_vector_data)
{
	// Input checking
...
void geometry::write_particles_to_vtk(std::string path, const std::vector<Eigen::Vector3d>& particles, const std::vector<double>& particle_scalar_data)
{
	write_particles_to_vtk(path, particles, particle_scalar_data, std::vector<Eigen::Vector3d>());
}

std::vector<geometry::TriMesh> geometry::read_tri_meshes_from_obj(std::string filename)
{
