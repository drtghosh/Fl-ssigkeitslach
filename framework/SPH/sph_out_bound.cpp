...
namespace WCSPH
{
	...
	void SPHOB::simulate(CompactNSearch::Real t_end) {
		auto start = std::chrono::system_clock::now();
	...
	void SPHOB::load_geometry(bool has_boundary, WCSPH::Vector& boundary_size, WCSPH::Vector& bottom_left_boundary, std::vector<WCSPH::Vector>& fluid_sizes, std::vector<WCSPH::Vector>& bottom_lefts_fluid, std::vector<std::array<WCSPH::Vector, 4>>& obstacle_squares) {
		auto start = std::chrono::system_clock::now();
	...
	void SPHOB::compute_boundary_mass(unsigned int boundary_id, CompactNSearch::PointSet const& ps_boundary) {
	...
	void SPHOB::calculate_particle_density(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
	...
	void SPHOB::semi_implicit_euler() {
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
	...
	void SPHOB::calculate_pressure(bool first_step) {
	...
	void SPHOB::calculate_acceleration(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
	...
	void SPHOB::calculate_pressure_acceleration(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
		// Loop over all fluid particles
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
		for (int i = 0; i < ps_fluid.n_points(); ++i) {
	...
	void SPHOB::calculate_viscosity_acceleration(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
		// Loop over all fluid particles
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
		for (int i = 0; i < ps_fluid.n_points(); ++i) {
			// Initialize acceleration
	...
	void SPHOB::calculate_other_acceleration() {
		if (!gravity_only) {
	...
	void SPHOB::calculate_fluid_normals(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid) {
		// Loop over all fluid particles
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
		for (int i = 0; i < ps_fluid.n_points(); ++i) {
			// Initialize acceleration
	...
	void SPHOB::calculate_st_acceleration(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
		// Loop over all fluid particles
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
		for (int i = 0; i < ps_fluid.n_points(); ++i) {
			// Initialize acceleration
	...
	void SPHOB::calculate_adhesion_acceleration(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid, unsigned int boundary_id) {
		// Loop over all fluid particles
		#pragma omp parallel for num_threads(parameters.num_threads) schedule(static)
		for (int i = 0; i < ps_fluid.n_points(); ++i) {
			// Initialize acceleration
	...
	void SPHOB::update_time_step_size() {
	...
	void SPHOB::check_particle_positions() {
	...
	void SPHOB::turn_off_gravity() {
		this->gravity_acceleration = { 0.0, 0.0, 0.0 };
	}

	void SPHOB::turn_on_gravity() {
		this->gravity_acceleration = { 0.0, 0.0, -9.81 };
	}

	void SPHOB::add_initial_velocity(std::vector<WCSPH::Vector> velocities) {
		assert(velocities.size() == this->fluid_velocities.size());
		this->fluid_velocities = velocities;
	}

	void SPHOB::add_relative_velocity(WCSPH::Vector relative_velocity) {
	...
	int SPHOB::num_boundary_particles() {
		return boundary_particles.size();
	}

	int SPHOB::num_fluid_particles() {
		int num_particles = 0;
	...
	int SPHOB::num_timesteps() {
		return timesteps;
	}

	void SPHOB::printStats(std::string test) {
	...
	void SPHOB::update_grid_values(unsigned int fluid_id, CompactNSearch::PointSet& ps_fluid) {
	...
	void SPHOB::calculate_mc_normals() {
	...
	void SPHOB::export_data(unsigned int frame) {
