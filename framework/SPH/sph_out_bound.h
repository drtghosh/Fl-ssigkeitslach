...
namespace WCSPH
{
	...
	public:
		// Constructor
		SPHOB(bool gravity_only, bool with_initial_velocity, bool with_surface_tension, std::string result_path, SPHParameters params, MCParameters mcparams);

		// Destructor
		virtual ~SPHOB() = default;
